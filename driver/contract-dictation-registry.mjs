...
// one seat and an order for a tool the next seat does not hold. `clearance-register/SKILL.md` goes to
// register-unit and register-digest; `clearance-search/phase2-execution.md` goes to skeptic;
// `clearance-search/synthesis-rules.md` goes to synthesis AND report-overview. report-overview and
// clearance-variants are tool-free BY DESIGN, each with its reason written out in TOOL_FREE_STAGES;
...
export const TOOL_ORDER_BACKLOG = [
  ...
  { stage: "register-unit", tool: "band_shape", site: "driver/skills/clearance-register/SKILL.md",
    closes: "#865 — same shared file, same split grant." },
  { stage: "report-overview", tool: "band_record", site: "driver/skills/clearance-search/synthesis-rules.md",
    closes: "#865 — same shared file, same split grant." },
  ...
  { stage: "skeptic", tool: "register_propose_supplemental", site: "driver/skills/clearance-search/phase2-execution.md",
    closes: "#865 — same seat, same file, the supplemental mint it cannot call." },
  { stage: "report-overview", tool: "perplexity_research", site: "driver/skills/clearance-search/synthesis-rules.md",
  ...
  { stage: "report-overview", tool: "band_lookup", site: "driver/skills/clearance-search/synthesis-rules.md",
    closes: "#865 — same shared file, same split grant." },
  { stage: "clearance-variants", tool: "perplexity_research", site: "driver/skills/clearance-variants/SKILL.md",
    closes: "#865 — clearance-variants is TOOL-FREE by design ('pure reasoning over material already on "
