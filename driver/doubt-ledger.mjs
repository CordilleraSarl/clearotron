...
// clearance-register layer cross-check" note that NOTHING parses. The resolutions usually EXIST — in
...
// artifacts (and free prose like "requires clearance-register layer cross-check" buried in a paragraph —
