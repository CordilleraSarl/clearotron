...
export const E3_BACKLOG = [
  // ── clearance-variants: FOUR ROWS RETIRED BY CONVERSION 3 ──────────────────────────────────────────
  //
  ...
  },
  {
    ...
    //   quote      — M2 LANDED. The live field is `anchor` (clearance-common-law/SKILL.md:197).
...

  {
    stage: "register-unit",
    kind: "literal-json-skeleton",
    where: "driver/stages.mjs:2283 (the non-supplemental-lane branch)",
    surface: "stage-message",
  ...
  },
  {
    ...
    reparsedBy: "driver/pipeline.mjs — the PLACEMENT RULINGS TAIL block handed to register-digest is lifted from these named sections (stages.mjs:2559 references it); driver/skills/clearance-register/digest.md:342-352 re-parses the Disagreements section into its own table",
    removedByMove: "NOTHING ON THE #850 PLAN REMOVES THIS",
  },
  ...
  // records nobody ordered.
  {
    ...
    where: "driver/stages.mjs:2653 (the digest message) + driver/coverage-form.mjs (coverageFormBrief — the dispatch block carrying the enum and the row shape)",
    surface: "stage-message",
  ...
  // "driver/skills/clearance-search/phase2-execution.md:96-98", evidence "`## Escalation decisions` section the
  ...
  // THIS", which was true of the plan and not of the conversion that came after it.
  {
    ...
    reparsedBy: "driver/pipeline.mjs runSupplementalSweeps — the remedy lint refuses a label-shaped term; stages.mjs:2825 restates the same shape in the message (\"THE ASK CONTRACT, stated at BOTH levels\")",
    removedByMove: "NOTHING ON THE #850 PLAN REMOVES THIS",
  },
  {
    stage: "synthesis",
    kind: "literal-json-skeleton",
    where: "driver/stages.mjs:3213",
    surface: "stage-message",
  ...
  // this commit for the same reason.
  {
    stage: "synthesis",
    kind: "dictated-line-shape",
    where: "driver/stages.mjs:3112 (restated at driver/skills/clearance-search/synthesis-rules.md:428)",
    surface: "stage-message",
  ...
  },
  {
    stage: "synthesis",
    kind: "dictated-line-shape",
    where: "driver/stages.mjs:3125 (restated at driver/skills/clearance-search/synthesis-rules.md:475)",
    surface: "stage-message",
 ...
 * always the QUOTE. Three are re-quoted in this commit and clear: clearance-variants (its evidence was a
...
export const E3_EVIDENCE_UNRESOLVED = [
  ...
  // `where: "driver/stages.mjs:3073"`, so which one occupied this slot could not be read off the strings.
