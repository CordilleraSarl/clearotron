...
export const E3_BACKLOG = [
  ...
  },
  {
    stage: "common-law",
    kind: "dictated-line-shape",
    where: "driver/stages.mjs (the no-grid-spec legacy branch: its forms-count line and its write-up ABSOLUTE path line)",
    surface: "stage-message",
...
export const E3_EVIDENCE_UNRESOLVED = [
  ...
  // `where` naming `driver/stages.mjs` with no element, so which one occupied this slot could not be read off the strings.
