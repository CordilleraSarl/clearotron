...
export const E3_BACKLOG = [
  ...
  //
  //   stages.mjs:928            the dispatch dictated variant-manifest.json key by key and enum by enum;
  ...
  //
  // It read: stage "blind-frame", where "driver/stages.mjs:980", evidence "Emit the STRUCTURED model
  ...
  // against, not every plan that might ever reach it.
  {
    ...
    where: "driver/stages.mjs:1087 (emitted at 1038, 1067, 1153, 1282)",
  ...
  },
  {
    ...
    kind: "dictated-line-shape",
    // CONSOLIDATED 2026-08-16 from THREE rows (common-law stages.mjs:1037, common-law-half :1112 and
  ...
  },
  {
    stage: "common-law",
    kind: "dictated-line-shape",
    where: "driver/stages.mjs:1060 and driver/stages.mjs:1065 (the no-grid-spec legacy branch)",
    surface: "stage-message",
...

  {
    stage: "register-unit",
    kind: "literal-json-skeleton",
    where: "driver/stages.mjs:2249 (the non-supplemental-lane branch)",
    surface: "stage-message",
  ...
  },
  {
    ...
    reparsedBy: "driver/placement-model.mjs. AND IT IS STALE: #562 made placements.json driver-rendered, and stages.mjs:2379 says \"DO NOT WRITE placements.json (the driver renders it from this form)\" — the skill file the stage is ordered to \"read and follow exactly\" dictates the key set of a file the message forbids it to write. Two contracts in one dispatch",
    removedByMove: "NOTHING ON THE #850 PLAN REMOVES THIS",
  },
  {
    stage: "placement-inquiry",
    ...
    reparsedBy: "driver/pipeline.mjs — the PLACEMENT RULINGS TAIL block handed to register-digest is lifted from these named sections (stages.mjs:2565 references it); driver/skills/prelim-register/digest.md:342-352 re-parses the Disagreements section into its own table",
    removedByMove: "NOTHING ON THE #850 PLAN REMOVES THIS",
  },
  ...
  // the COMMENT recording the deletion (stages.mjs:2199), and skill-contract-enumerations.test.mjs
  ...
  // records nobody ordered.
  {
    ...
    where: "driver/stages.mjs:2614 (the digest message) + driver/coverage-form.mjs (coverageFormBrief — the dispatch block carrying the enum and the row shape)",
    surface: "stage-message",
  ...
  // THIS", which was true of the plan and not of the conversion that came after it.
  {
    ...
    reparsedBy: "driver/pipeline.mjs runSupplementalSweeps — the remedy lint refuses a label-shaped term; stages.mjs:2794 restates the same shape in the message (\"THE ASK CONTRACT, stated at BOTH levels\")",
    removedByMove: "NOTHING ON THE #850 PLAN REMOVES THIS",
  },
  {
    stage: "synthesis",
  ...
  // this commit for the same reason.
  {
    stage: "synthesis",
    kind: "dictated-line-shape",
    where: "driver/stages.mjs:3069 (restated at driver/skills/prelim-search/synthesis-rules.md:428)",
    surface: "stage-message",
  ...
  },
  {
    stage: "synthesis",
    kind: "dictated-line-shape",
    where: "driver/stages.mjs:3082 (restated at driver/skills/prelim-search/synthesis-rules.md:475)",
    surface: "stage-message",
  ...
  },
  {
    ...
    reparsedBy: "driver/verify.mjs validators.caseLaw — the ledger arm, armed by the stage-contract marker `citations` (stages.mjs:1816)",
  ...
  },
  {
    ...
    reparsedBy: "driver/publish/parse.mjs:339 parseCaseLawProfiles (\"the optional '- ord: <N>' first body line … gives an EXACT join\"); driver/findings-model.mjs:273 /^-\\s*ord:\\s*(\\d+)\\s*$/m; driver/publish/index.mjs:796",
    removedByMove: "NOTHING ON THE #850 PLAN REMOVES THIS",
  },
  {
    stage: "case-law",
  ...
  },
  {
    stage: "narrative-refutation",
    kind: "dictated-line-shape",
    where: "driver/stages.mjs:1875 and driver/skills/narrative-refutation/SKILL.md:41-50",
