...
export const E3_BACKLOG = [
  ...
  // records nobody ordered.
  {
    ...
    where: "driver/stages.mjs:2618 (the digest message) + driver/coverage-form.mjs (coverageFormBrief — the dispatch block carrying the enum and the row shape)",
    surface: "stage-message",
  ...
  },
  {
    ...
    reparsedBy: "driver/findings-model.mjs:813 parseFindingsJson; driver/verify.mjs:1153 checkFindingsSibling gates meters.*.source; finding_basis_source_missing",
    removedByMove: "NOTHING ON THE #850 PLAN REMOVES THIS",
  },
  {
    stage: "synthesis",
    kind: "literal-json-skeleton",
    where: "driver/stages.mjs:3232",
    surface: "stage-message",
  ...
  // this commit for the same reason.
  {
    stage: "synthesis",
    kind: "dictated-line-shape",
    where: "driver/stages.mjs:3077 (restated at driver/skills/prelim-search/synthesis-rules.md:428)",
    surface: "stage-message",
  ...
  },
  {
    stage: "synthesis",
    kind: "dictated-line-shape",
    where: "driver/stages.mjs:3090 (restated at driver/skills/prelim-search/synthesis-rules.md:475)",
    surface: "stage-message",
  ...
  },
  {
    ...
    reparsedBy: "driver/verify.mjs:846 CORRECTION_ON_RE = /\\[on:\\s*([0-9,\\s-]*?)\\s*\\]/i. SKILL-FILE ONLY — the stage message at stages.mjs:1842-1877 never mentions `[on:]`. This is #850's \"the element shape is in the skill file, not the stage message\" in its purest form: an E3 lint reading stages.mjs alone sees the [kind:] token and misses its twin",
    removedByMove: "NOTHING ON THE #850 PLAN REMOVES THIS",
  },
  {
    stage: "narrative-refutation",
