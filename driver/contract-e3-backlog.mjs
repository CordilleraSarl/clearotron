...
export const E3_BACKLOG = [
  ...
  },
  {
    ...
    where: "driver/connotation-search.mjs:1425-1438 (renderConnotationObligations; delivered to the seat via driver/engine/mcp/perplexity-server.mjs:111 — a TOOL RESPONSE, no longer a stage message)",
