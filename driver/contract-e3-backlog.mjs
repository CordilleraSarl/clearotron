...
export const E3_BACKLOG = [
  ...
  // this commit for the same reason.
  {
    stage: "synthesis",
    kind: "dictated-line-shape",
    where: "driver/stages.mjs:3081 (restated at driver/skills/prelim-search/synthesis-rules.md:428)",
    surface: "stage-message",
  ...
  },
  {
    stage: "synthesis",
    kind: "dictated-line-shape",
    where: "driver/stages.mjs:3094 (restated at driver/skills/prelim-search/synthesis-rules.md:475)",
    surface: "stage-message",
