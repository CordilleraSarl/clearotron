...
export const E3_BACKLOG = [
...

  {
    stage: "register-unit",
    kind: "literal-json-skeleton",
    where: "driver/stages.mjs:2282 (the non-supplemental-lane branch)",
    surface: "stage-message",
  ...
  // records nobody ordered.
  {
    ...
    where: "driver/stages.mjs:2651 (the digest message) + driver/coverage-form.mjs (coverageFormBrief — the dispatch block carrying the enum and the row shape)",
    surface: "stage-message",
  ...
  // this commit for the same reason.
  {
    stage: "synthesis",
    kind: "dictated-line-shape",
    where: "driver/stages.mjs:3110 (restated at driver/skills/clearance-search/synthesis-rules.md:428)",
    surface: "stage-message",
  ...
  },
  {
    stage: "synthesis",
    kind: "dictated-line-shape",
    where: "driver/stages.mjs:3123 (restated at driver/skills/clearance-search/synthesis-rules.md:475)",
    surface: "stage-message",
...
export const E3_EVIDENCE_UNRESOLVED = [
  ...
  // `where: "driver/stages.mjs:3071"`, so which one occupied this slot could not be read off the strings.
