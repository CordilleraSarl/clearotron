 ...
 * HEADER row — the live clearance-variants format is `| Category | Value | Rationale | Verify? |`
...
//     per cell "without judging similarity" (skills/clearance-common-law/perplexity-prompts.md), and the
