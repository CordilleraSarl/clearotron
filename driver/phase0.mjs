...
// Mirrors clearance-search/SKILL.md Phase 0 + Phase 1 slug derivation.
...
//
// `clearance-<slug>-<codename>-` is not just a directory name. It is the ONLY thing separating one run's
...
/**
 * Claim `clearance-<slug>-<codename>-` for this run, and report whether we got it.
 *
