...
function deployment(root, { queue = {}, outbox = [], run = null } = {}) {
  ...
  let runDir = null;
  if (run) {
    runDir = join(root, "workspace", "clearance-search", "fixture-mark", "2026-08-05-fixture-two");
...
test("the harness derives the SAME runId forms the engine honours, FALLBACK INCLUDED", () => {
  ...
  const runDir = "/w/clearance-search/fixture-mark/2026-08-05-fixture-two";
...
test("TEETH — a run with no runId and a packet on disk is found, and another run's is not", () => {
  scratch((root) => {
    ...
    const runDir = join(root, "workspace", "clearance-search", "fixture-mark", "2026-08-05-fixture-two");
    ...
    const other = join(root, "workspace", "clearance-search", "fixture-mark", "2026-08-04-fixture-two");
