...
test("only rounds that are NOT SETTLED are listed — a SETTLED round is done", () => {
  ...
  // (previousRoundNotice in e2e.mjs) and "PASS" is not that word, so under the corrected rule
...
// found. The harness already knew: previousRoundNotice in e2e.mjs closes a round on
