...
test("the framework is its own, and its provenance note is clean", () => {
  ...
  const m = loadFrameworkManifest(join(ROOT, "driver"), "skills/clearance-search/risk-framework-demo.md");
  ...
  const md = readFileSync(join(ROOT, "driver", "skills", "clearance-search", "risk-framework-demo.md"), "utf8");
