...
// month — while `driver/skills/clearance-register/providers/signa.md` instructed the model to use
...
const RECORDING_GRANTS = Object.freeze({
  ...
  //   · clearance-variants holds its record tool and nothing else. Its Class 2 reads are ENUMERABLE — the
  ...
  "clearance-variants": Object.freeze(["mcp__recording-clearance-variants__record_clearance_variants"]),
  //   · report-overview holds its record tool and nothing else, on the frame-diff/clearance-variants ruling:
