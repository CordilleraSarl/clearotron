...
test("a <kind>:<path> failure is nameable, and it was not before", () => {
  for (const reason of [
    "invalid_file:clearance-search/x/common-law-findings.half-a.md",
    "missing_file:clearance-search/x/common-law-findings.half-m.md",
  ]) {
...
test("naming the failure moves NO budget — the class is untouched", () => {
  ...
  const f = failureSignature("common-law-half:a", "invalid_file:clearance-search/x/y.md");
  assert.equal(classifyFailureReason("invalid_file:clearance-search/x/y.md"), "unknown",
