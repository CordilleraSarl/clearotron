...
test("extractBandMeanings: ANY miss ⇒ null (no partial box); garbled input never throws", () => {
  const msManifest = loadFrameworkManifest(DRIVER_ROOT, "skills/clearance-search/risk-framework-aurora.md");
  const houseManifest = loadFrameworkManifest(DRIVER_ROOT, "skills/clearance-search/risk-framework.md");
  const msDeck = readFileSync(join(DRIVER_ROOT, "skills/clearance-search/risk-framework-aurora.md"), "utf8");
