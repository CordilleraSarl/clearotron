...
//
// CROSS-SKILL — a link into ANOTHER skill's document. clearance-variants cites a step of
// clearance-register/SKILL.md; clearance-register's own two dispatches already measure that file. Counting it
