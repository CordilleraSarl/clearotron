...
const CONVERTED_BEFORE = Object.freeze({
  ...
  // clearance-variants, retired by conversion 3 — measured on the same walk as the four above and identical
  ...
  "clearance-variants": { groups: 0, allowedTools: false, mcpConfig: false, strictMcpConfig: false },
