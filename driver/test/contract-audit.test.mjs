...
test("⭐ #1202 E2 soundness: the census READS the acceptance boundary, and this is a detection", () => {
  ...
  const ACCEPTANCE = ["matter-frame-record.mjs", "clearance-variants-record.mjs", "skeptic-record.mjs",
...
test("E3: the backlog is explicit, named, and each entry says which move removes it", () => {
  ...
  // 69 → 64 → 60. Conversion 2 retired matter-frame's five rows; conversion 3 retired clearance-variants'
