...
//
// `clearance-variants` strips the DOMINANT ELEMENT to a formative root and sweeps that root as a
...
const DOCTRINE = join(dirname(fileURLToPath(import.meta.url)), "..", "skills", "clearance-variants", "SKILL.md");
