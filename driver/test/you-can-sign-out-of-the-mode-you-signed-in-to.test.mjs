...
test("sign-out is a RESERVED server route, or the shell answers it with a silent 200", () => {
...
test("the local branch's gate ADMITS the route, or its half is unreachable code", () => {
...
test("the population this walks is real, so an empty result means something", () => {
...
test("NO surface links straight to Cloudflare's endpoint any more", () => {
...
test("the three known emitters now point at the resolving route", () => {
