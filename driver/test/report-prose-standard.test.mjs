...
//
// WHY THIS FILE EXISTS. A prompt-only change has no failure mode. If `skills/clearance-search/report-prose.md`
...
const STANDARD = "skills/clearance-search/report-prose.md";
...
const MACHINE_STAGES = ["matter-frame", "clearance-variants", "register-digest", "placement-inquiry", "frame-diff"];
