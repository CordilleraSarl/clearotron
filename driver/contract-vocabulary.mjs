...
export const VOCABULARY = [
  ...
  { token: "coverage_clean_unexecuted", stages: ["register-digest"], site: "driver/verify.mjs, the matterContext validator", family: "driver/register-plan.mjs:1730 validatePlanFeasibility", dynamic: "D6" },
