...
//   D7 verify.mjs:1558  fail(`${v2[0].token}${detail}…`)     — register-plan.mjs:2319 disclosureTextByAxis
...
export const VOCABULARY = [
  ...
  { token: "coverage_clean_unexecuted", stages: ["register-digest"], site: "driver/verify.mjs, the matterContext validator", family: "driver/register-plan.mjs:1761 validatePlanFeasibility", dynamic: "D6" },
  { token: "coverage_clean_skipped", stages: ["register-digest"], site: "driver/verify.mjs, the matterContext validator", family: "driver/register-plan.mjs:2091 searchedJurisdictionsFromPlan", dynamic: "D6" },
  { token: "coverage_clean_unverified_incomplete", stages: ["register-digest"], site: "driver/verify.mjs, the matterContext validator", family: "driver/register-plan.mjs:2319 disclosureTextByAxis", dynamic: "D7" },
