...
> **There is no dedicated conduct mailbox.** [SECURITY.md](SECURITY.md) sets out what private
> reporting route this repository has, and whichever one is available there takes a conduct report
> too — say in the first line that your report is about conduct, not a vulnerability. Follow that
> file's instructions rather than describing the incident in a public issue.
