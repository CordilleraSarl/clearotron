...
// What a company is CALLED, as against what it is keyed by.
//
...
// same company appeared as "Foxglade Interactive" in the rail and "foxglade" in the heading beside it,
...
//     gap; an empty label where a company should be is a broken screen. Nothing here titlecases or
...
/** The "no particular company" view. One string, so the switcher and every label agree on it. */
...
/** A company's display name. `null` is the all-owners view; an unknown key reads as itself. */
