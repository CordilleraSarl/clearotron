...
and a beta is cut deliberately — when a change lands that somebody should test, or while a stable is being
...
**So a note you write today ships to beta readers at the next cut, and to stable readers when the next
